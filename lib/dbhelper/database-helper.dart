...
class DatabaseHelper {
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE User(id INTEGER PRIMARY KEY, name TEXT, username TEXT, password TEXT, flaglogged TEXT, age TEXT, degree TEXT, university TEXT)");
    print("Table is created");

    // await db.execute(
    //     "CREATE TABLE User(id INTEGER PRIMARY KEY, age TEXT, degree TEXT, university TEXT)");
    // print("Table is created");
  }
